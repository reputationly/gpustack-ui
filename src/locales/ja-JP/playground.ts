export default {
  ...
  'playground.video.input.srcVideo': 'ソース動画',
  'playground.video.input.srcMask': 'マスク動画',
  'playground.video.input.srcRefImages': '参照画像',
  'playground.video.input.srRatio': 'アップスケール倍率',
  'playground.video.input.required': '{field}は必須です',
  'playground.video.input.vaceRequired':
