export default {
  ...
  'playground.video.input.srcVideo': 'Исходное видео',
  'playground.video.input.srcMask': 'Маска-видео',
  'playground.video.input.srcRefImages': 'Референсные изображения',
  'playground.video.input.srRatio': 'Коэффициент увеличения',
  'playground.video.input.required': 'Требуется {field}',
  'playground.video.input.vaceRequired':
    'VACE требует исходное видео или референсное изображение',
